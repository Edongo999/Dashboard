  ...
  return (
    <div className="flex min-h-screen bg-[#F3F4F6]">
      ...
      <main className="flex-1 overflow-auto p-6">
        ...
        {/* ✅ Titre sur deux lignes en mobile + avatar fixe à droite */}
        <div className="relative mb-6">
          ...
          {/* ✅ Titre centré en mobile, aligné en desktop */}
          <h1 className="text-3xl font-bold text-gray-800 leading-snug text-center lg:text-left pr-16 lg:pr-0">
