  ...
  return (
    <div className="flex min-h-screen bg-[#F3F4F6]">
      ...
      <main className="flex-1 overflow-auto p-6">
        ...
        {/* ✅ Titre centré + avatar fixe en haut à droite */}
        <div className="relative mb-6">
          ...
          {/* ✅ Titre toujours centré, jamais chevauché */}
          <h1 className="text-3xl font-bold text-gray-800 leading-snug text-center pr-16">
            <span className="block">Tableau de bord</span>
            <span className="block">administrateur</span>
          </h1>
        </div>
