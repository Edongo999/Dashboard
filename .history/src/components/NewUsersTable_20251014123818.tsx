...
const avatarUrl = "https://i.pravatar.cc/40?u=default-avatar" // ✅ Avatar par défaut stable
        ...
        <table className="min-w-[500px] w-full text-[15px] text-left">
          <thead>
            <tr className="bg-[#F9FAFB] text-gray-500 font-normal">
              ...
              <th className="py-2 px-6 text-center">Montant</th>
