...
const avatarUrl = "https://ui-avatars.com/api/?name=Client&background=F3F4F6&color=111827" // ✅ Avatar neutre et stable
        ...
        <table className="min-w-[500px] w-full text-[15px] text-left">
          <thead>
            <tr className="bg-[#F9FAFB] text-gray-500 font-normal">
              ...
              <th className="py-2 px-12 text-center">Montant</th>
