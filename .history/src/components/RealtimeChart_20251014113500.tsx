...
// 🔧 MODIFICATION ICI : valeurs fidèles à ton image
const datasets = {
  jour: [
...
const RealtimeChart = () => {
  ...
  return (
    // 🔧 MODIFICATION ICI : largeur élargie à 840px
    <div className="bg-white rounded-[12px] shadow-md p-6 w-[840px]">
      ...
      {/* 🔧 MODIFICATION ICI : hauteur augmentée à h-80 */}
      <div className="h-80">
