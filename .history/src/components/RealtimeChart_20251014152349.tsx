...
const RealtimeChart = () => {
  ...
  return (
    // ✅ Hauteur synchronisée avec SecurityIndicators
    <div className="bg-white rounded-[12px] shadow-md p-6 w-full min-h-[420px] flex flex-col justify-between">
      ...
      {/* ✅ Graphique qui remplit l’espace vertical */}
