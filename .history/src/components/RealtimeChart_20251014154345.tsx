...
const RealtimeChart = () => {
  ...
  return (
    // ✅ Largeur fluide + hauteur synchronisée
    <div className="bg-white rounded-[12px] shadow-md p-6 w-full max-w-[680px] mx-auto flex flex-col justify-between min-h-[420px]">
      ...
      {/* ✅ Graphique visible avec hauteur fixe */}
