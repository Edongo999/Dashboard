...
// ✅ Image par défaut : photo réaliste d'une personne (femme souriante)
...
const RecentActivity = () => {
  return (
    ...
    <div className="bg-white rounded-[12px] shadow-md p-6 w-full lg:max-w-[600px]">
      ...
      {/* ✅ En-tête avec titre en gras et filtre de période */}
        ...
        <table className="min-w-[500px] w-full text-[15px] text-left">
          ...
          <thead>
            <tr className="bg-[#F9FAFB] text-gray-500 font-normal">
              ...
              <th className="py-2 px-20 text-center">Montant</th> {/* ✅ Montant reculé avec px-20 */}
                ...
                <tr key={i} className="text-gray-700 align-middle text-[16px]">
                  ...
                  <td className="py-3 px-4">
                    <div className="flex items-center gap-3">
                      <img
                        src={avatarUrl} // ✅ Image par défaut réaliste
                        alt={tx.name}
