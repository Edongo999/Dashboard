...
const SecurityIndicators = () => {
  ...
  return (
    // ✅ Centrage parfait sur mobile, largeur fluide
    <div className="bg-white rounded-[12px] shadow-md p-6 w-full max-w-[340px] mx-auto flex flex-col items-center justify-between min-h-[420px]">
