...
const SecurityIndicators = () => {
  ...
  return (
    // ✅ Centrage parfait sur mobile, largeur contrôlée
    <div className="bg-white rounded-[12px] shadow-md p-6 w-full max-w-[340px] flex flex-col items-center justify-between min-h-[420px]">
