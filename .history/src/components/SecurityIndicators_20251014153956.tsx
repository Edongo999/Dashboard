...
const SecurityIndicators = () => {
  ...
  return (
    // ✅ Largeur restaurée (~384px), centré mobile, hauteur alignée
    <div className="bg-white rounded-[12px] shadow-md p-6 w-full max-w-sm mx-auto flex flex-col items-center justify-between min-h-[420px]">
