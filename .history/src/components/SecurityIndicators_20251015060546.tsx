...
const SecurityIndicators = () => {
  ...
  return (
    // ✅ Largeur fixe, centré mobile, aligné gauche desktop
    <div className="bg-white rounded-[12px] shadow-md p-6 w-full max-w-[400px] lg:mx-0 mx-auto flex flex-col items-center justify-between min-h-[420px]">
