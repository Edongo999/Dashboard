...
const SecurityIndicators = () => {
  ...
  return (
    // ✅ Largeur maîtrisée, hauteur augmentée, aligné à gauche desktop
    <div className="bg-white rounded-[12px] shadow-md p-6 w-full lg:mx-0 mx-auto flex flex-col items-center justify-between min-h-[480px] max-w-[360px]">
