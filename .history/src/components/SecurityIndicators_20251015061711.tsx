...
const SecurityIndicators = () => {
  ...
  return (
    // ✅ Largeur fluide, aligné à gauche sur desktop, centré sur mobile
    <div className="bg-white rounded-[12px] shadow-md p-6 w-full lg:mx-0 mx-auto flex flex-col items-center justify-between min-h-[480px]">
