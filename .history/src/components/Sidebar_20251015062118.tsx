...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* ✅ Sidebar avec hauteur fluide */}
      <aside
        className={`fixed top-0 left-0 w-64 h-full bg-[#656A74] text-neutral-content flex flex-col justify-between p-4 z-40 transition-transform duration-300 ${
