...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* ✅ Sidebar intégré dans le flux, hauteur contrôlée par le contenu */}
      <aside
        className={`w-64 bg-[#656A74] text-neutral-content flex flex-col justify-between p-4 lg:block hidden`}
      >
        {/* ✅ Logo + titre */}
        <div>
