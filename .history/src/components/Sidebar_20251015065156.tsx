...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* ✅ Sidebar desktop avec hauteur limitée */}
      <aside className="hidden lg:flex flex-col w-64 h-[680px] bg-[#656A74] text-neutral-content p-4">
        <div>
          <div className="flex items-center gap-3 mb-10">
            <div className="bg-orange-500 text-white rounded-full w-10 h-10 flex items-center justify-center font-bold text-sm shrink-0">
              M
        ...
        {/* ✅ Bloc version collé vers le bas */}
